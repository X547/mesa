...
static VkResult
nvkmd_nvrm_sync_init(struct vk_device *device,
                    struct vk_sync *sync,
...
static VkResult
nvkmd_nvrm_sync_signal(struct vk_device *device,
                      struct vk_sync *sync,
                      uint64_t value)
{
   struct nvkmd_nvrm_sync *sobj = to_nvkmd_nvrm_sync(sync);
...
static VkResult
nvkmd_nvrm_sync_get_value(struct vk_device *device,
                         struct vk_sync *sync,
                         uint64_t *value)
{
   struct nvkmd_nvrm_sync *sobj = to_nvkmd_nvrm_sync(sync);
...
static VkResult
nvkmd_nvrm_sync_reset(struct vk_device *device,
                     struct vk_sync *sync)
{
   struct nvkmd_nvrm_sync *sobj = to_nvkmd_nvrm_sync(sync);
   return VK_SUCCESS;
...
static VkResult
nvkmd_nvrm_sync_wait_many(struct vk_device *device,
                         uint32_t wait_count,
